...
for(i in 1:N){
  ...
  objectRatings[,i]    <- scan(paste('data/objectRatings_', as.character(subNo[i]) ,'.dat', sep = ''))
}
...
The ratings are spread across the scale. However it is also interesting to look at the individual distributions. Therefor I plot one histograms for each participant. 
