...
##  Conclusion
All models except the last two can be estimated with a decent accuracy. The problem for the last two models is that on rare occasion the model fails to converge or the correlation coefficients for $\hat{\beta_{0.j}}$ and their true value is very low. At the moment, I don't really know what to do about it. 